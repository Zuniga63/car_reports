/**
 * @fileoverview Se encarga de crear reportes a partir de datos suministrados.
 ...
 * brand[String], price[number] y model [number]
 * @type {Array}
 */
const cars = [
...
/**
 * Return all the cars of Ferrary brand.
 * @param {Array} cars List of data.
 * @returns {Array}
 */
function ferrary(cars) {
  return cars.filter((car) => car.brand === "Ferrari");
}

/**
 * Return all the cars of BMW brand.
 * @param {Array} cars List of data.
 * @returns {Array}
 */
function bmw(cars) {
...
/**
 * Return all the cars with models between 1980 and 1990
 * @param {Array} cars List of data.
 * @returns {Array}
 */
...
/**
 * Return and array of string with the same number os cars.
 ...
 */
function list(cars) {
  return cars.map((car) => `This ${car.brand} from ${car.model} cost $${car.price}`);
}

/**
 * Returns the sum of all prices of the BMW cars
 * @param {Array} cars List of data.
 * @returns {Array}
 */
function bmwSum(cars) {
  let bmwCars = bmw(cars);
  return bmwCars.reduce((sum, car) => sum + car.price,0);
}


console.group("Metodo ferrary:", ferrary(cars));
console.group("Metodo nineties:", nineties(cars));
console.group("Metodo bmwSum:", bmwSum(cars));
